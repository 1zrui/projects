...
tfs = [("15m", m15['trend'], UP), ("1h", h1['trend'], UP), ("4h", h4['trend'], UP)]
x0 = 150
...
res_str = f"压力  {res1:.2f}  (1h 摆动高)"
sup_str = f"支撑  {sup15:.2f}  (15m)  /  {e20_1:.2f}  (EMA20)"
d.text((80, 394), res_str, font=font(22), fill=DOWN)
d.text((80, 430), sup_str, font=font(22), fill=UP)
...
if net >= 2:
    direction = "做多（条件）"
    lines = [
        f"① 趋势: {m15['trend']}/{h1['trend']}/{h4['trend']}",
